...
/// 与 <c>sz</c> 的行为一致。由 <c>TerminalTransferRouter</c> 每会话经 sourceFactory 新建一个实例。
/// </summary>
internal sealed class PickedFilesTransferSource(
    Func<bool, CancellationToken, Task<IReadOnlyList<string>>> pickFilesAsync) : IFileTransferSource
{
